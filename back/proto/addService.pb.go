...
func (x *Request) Reset() {
	*x = Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_addService_proto_msgTypes[0]
...
func (*Request) Descriptor() ([]byte, []int) {
	return file_proto_addService_proto_rawDescGZIP(), []int{0}
}
...
func (x *Response) Reset() {
	*x = Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_addService_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return file_proto_addService_proto_rawDescGZIP(), []int{1}
}
...
var File_proto_addService_proto protoreflect.FileDescriptor

var file_proto_addService_proto_rawDesc = []byte{
	0x0a, 0x16, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x61, 0x64, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x28, 0x03, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x32, 0x61, 0x0a, 0x0a, 0x41, 0x64,
...
var (
	file_proto_addService_proto_rawDescOnce sync.Once
	file_proto_addService_proto_rawDescData = file_proto_addService_proto_rawDesc
)

func file_proto_addService_proto_rawDescGZIP() []byte {
	file_proto_addService_proto_rawDescOnce.Do(func() {
		file_proto_addService_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_addService_proto_rawDescData)
	})
	return file_proto_addService_proto_rawDescData
}

var file_proto_addService_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_addService_proto_goTypes = []interface{}{
	(*Request)(nil),  // 0: proto.Request
	(*Response)(nil), // 1: proto.Response
}
var file_proto_addService_proto_depIdxs = []int32{
...
func init() { file_proto_addService_proto_init() }
func file_proto_addService_proto_init() {
	if File_proto_addService_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_addService_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_addService_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_addService_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_addService_proto_goTypes,
		DependencyIndexes: file_proto_addService_proto_depIdxs,
		MessageInfos:      file_proto_addService_proto_msgTypes,
	}.Build()
	File_proto_addService_proto = out.File
	file_proto_addService_proto_rawDesc = nil
	file_proto_addService_proto_goTypes = nil
	file_proto_addService_proto_depIdxs = nil
}
